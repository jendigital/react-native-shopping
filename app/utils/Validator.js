...
class Validator extends Component {
    //Most validate function recieve a value (or a group of value) and return undefined if there is no error,
 ...
 * @returns undefined as true, string as false
 */
function facade(constraints, input, input2 = undefined) {
    let result = undefined;
    if (input2 != undefined)
        result = validate({ foo: input, foo2: input2 }, constraints);
    else
        result = validate({ foo: input }, constraints);
 ...
 */
function removeFirstWord(result) {
